...
var _ doltdb.CustomTable = (*Sequence)(nil)
...
// HashOf implements the interface doltdb.CustomTable.
func (sequence *Sequence) HashOf(ctx context.Context) (hash.Hash, error) {
	data, err := sequence.Serialize(ctx)
	if err != nil {
		return hash.Hash{}, err
	}
	return hash.New(data), nil
}

// Name implements the interface doltdb.CustomTable.
