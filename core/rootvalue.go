...
// FindCustomTableNames implements the interface doltdb.RootValue.
func (root *RootValue) FindCustomTableNames(ctx context.Context, names []doltdb.TableName) (map[doltdb.TableName]struct{}, []doltdb.TableName, error) {
...
// GetCustomTable implements the interface doltdb.RootValue.
func (root *RootValue) GetCustomTable(ctx context.Context, tName doltdb.TableName) (doltdb.CustomTable, bool, error) {
...
func (root *RootValue) GetTableHash(ctx context.Context, tName doltdb.TableName) (hash.Hash, bool, error) {
	// TODO: get the hash of the CustomTable?
	tableMap, err := root.getTableMap(ctx, tName.Schema)
	if err != nil {
...
// IterCustomTables implements the interface doltdb.RootValue.
func (root *RootValue) IterCustomTables(ctx context.Context, cb func(name doltdb.TableName, table doltdb.CustomTable) (stop bool, err error)) error {
	rom, err := root.GetObjectMap(ctx)
	if err != nil {
		return err
	}
...
// PutCustomTable implements the interface doltdb.RootValue.
func (root *RootValue) PutCustomTable(ctx context.Context, tName doltdb.TableName, table doltdb.CustomTable) (doltdb.RootValue, error) {
	...
	default:
		return nil, fmt.Errorf("unknown custom table name format `%s`", tName.String())
	}
}
